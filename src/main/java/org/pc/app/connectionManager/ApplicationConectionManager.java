...
package org.pc.app.connectionManager;
...
@EnableJpaRepositories(basePackages = "org.pc", entityManagerFactoryRef = "dbEntityManager", transactionManagerRef = "dbTransactionManager")
public class ApplicationConectionManager {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		entityManager.setPackagesToScan("org.pc");
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		sessionBuilder.scanPackages("org.pc");
